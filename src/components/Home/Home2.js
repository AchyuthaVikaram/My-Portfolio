...
function Home2() {
  return (
    <Container fluid className="home-about-section" id="about" style={{fontWeight:"bold"}}>
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I'm passionate about creating impactful digital solutions and exploring new technologies.
              <br />
              ...
              <br />
              <br />
              I am driven by the desire to develop applications that simplify processes, such as event management systems and real-time platforms like <b className="purple">SkillXchange</b>.
              <br />
              <br />
              Whenever possible, I also contribute to open-source projects and refine my skills in frameworks like
              <i>
